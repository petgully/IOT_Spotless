...
print_summary() {
    ...
    echo "     It'll show '0 of 3 nodes online' until you do step 3."
    echo ""
    echo "  3. From a WINDOWS laptop, flash the 3 ESP32 boards. In the cloned repo:"
    echo "       .\\tools\\flash_node.ps1 all \\"
    echo "           -WifiSsid \"<your booth wifi>\" \\"
    echo "           -WifiPassword \"<password>\" \\"
    echo "           -MqttBroker \"${final_ip}\" \\"
    echo "           -Yes"
    echo "     See tools/README.md for prerequisites + troubleshooting."
    echo ""
    echo "  4. Power on the ESP32 boards. To verify they're online:"
    echo "       bash ${PI_DIR}/scripts/check_nodes.sh"
    echo ""
