...
NODES_CONFIG = {
    "spotless_node1": {
        ...
        "relays": {
            ...
            7: {"label": "BACK2", "description": "Backflow 2 (UNUSED — relay faulty)", "device": None, "has_led": False},
        }
    },
    "spotless_node2": {
        "name": "ESP32 Node 2",
        "relays": {
            ...
            6: {"label": "BACK1", "description": "Disinfectant pump (p4)", "device": "p4", "has_led": True, "led": "PRE-MIX1"},
            7: {"label": "BACK2", "description": "Backflow 2 (UNUSED — relay faulty)", "device": None, "has_led": False},
        }
    },
    "spotless_node3": {
